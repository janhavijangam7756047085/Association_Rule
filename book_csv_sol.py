...
df=pd.read_csv("E:/datascience/Association_Rule/book.csv")
df
...
'''the benefits/impact of the solution By identifying books
 that are frequently purchased together,the bookstore can
 create curated bundles or recommendations, enhancing the 
 overall shopping experience for customers.By using this 
 association rule we can stratergically placed the books 
 together to encourage the customer to purchased more items
 which will help to increased the overall revenue
